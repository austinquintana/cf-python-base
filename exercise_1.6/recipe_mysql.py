...
def main_menu(database_object, cursor):
    choice = ""
    while (choice != "quit"):
        print("\n======================================================")
        print("\nMain Menu:")
        ...
        if choice == "1":
            create_recipe(database_object, cursor)
        elif choice == "2":
            search_recipe(database_object, cursor)
        elif choice == "3":
            update_recipe(database_object, cursor)
        elif choice == "4":
            delete_recipe(database_object, cursor)
        elif choice == "5":
            view_all_recipes(database_object, cursor)

def create_recipe(database_object, cursor):
    recipe_ingredients = []
...
main_menu(database_object, cursor)
print("Goodbye\n")
